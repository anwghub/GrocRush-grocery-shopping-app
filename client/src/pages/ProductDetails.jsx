    ...
    return product && (
        <div className="mt-12">
            <p>
                ...
                <span className="bg-primary"> {product.name}</span>
            </p>
            ...
            <div className='flex flex-col items-center mt-20'>
              <div className='flex flex-col items-center w-max'>
                ...
                className='mx-auto cursor-pointer px-12 py-2.5 border rounded text-primary hover:bg-primary/10 transition'>See more</button>
              </div>
            </div>
        </div>
    );
