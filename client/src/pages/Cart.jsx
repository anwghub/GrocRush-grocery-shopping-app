...
const Cart = () => {
    const { products, currency, cartItems, removeFromCart, addToCart, getCartAmount, getCartCount, navigate, updateCartItem, } = useAppContext();
                    ...
                    {showAddress && (
                        <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                            {addresses.map((address, index) => (
                                <p onClick={() => { setSelectedAddress(addresses); setShowAddress(false) }} className="text-gray-500 p-2 hover:bg-gray-100">
